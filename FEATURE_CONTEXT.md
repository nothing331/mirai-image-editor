...
**Outcome.** An approved account can upload a PNG or JPEG, save it as a named private project, see it in My projects, and reopen the normalized original at `/projects/[id]` after signing out and back in. This is the P05 durable original checkpoint; cloud edit acceptance follows in P06.
...
**Dependencies and limits.** P03 authentication and P04 private assets are required. The first list is intentionally small: no thumbnails, search, sort controls, rename, or deletion until P08/P11. The project view is read-only until P06 durable edit acceptance, and P07 adds history navigation. The five active projects per account limit is an initial beta control.
...
**Limitations.** This local editor flow still stores projects on local-development infrastructure. P05 cloud projects store and reopen an original separately; cloud editing and history integration follow in P06–P07.
