...
| P02 | Complete; reproducible modes, fail-closed configuration, deployment/migration skeletons, health routes, live walkthrough, and pull-request CI passed. | Repeatable isolated deploy with AI off; no production data/secrets in tests |
